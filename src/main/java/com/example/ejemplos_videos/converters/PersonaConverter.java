...
public class PersonaConverter {
	public PersonaModelo entityToModel(Persona persona) {
		return new PersonaModelo(persona.getIdPersona(), persona.getNombre(), persona.getEdad(), persona.getPeso(), persona.getPais());
	}
	
	public Persona modelToEntity(PersonaModelo personaModelo) {
		return new Persona(personaModelo.getIdPersona(), personaModelo.getNombre(), personaModelo.getEdad(), personaModelo.getPeso(), personaModelo.getPais());
	}
}
